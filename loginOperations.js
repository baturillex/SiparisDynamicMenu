    ...
    request1.query("select * from Mekan where MekanAdi='" + req.params.MekanAdi + "'", function (err, verisonucu2) {
      request2.query("select Ad,Fiyat,Tur,Kategori,Servis from Menu where MekanAdi='" + req.params.MekanAdi + "' and Tur='İcecek'", function (
        ...
        request3.query("select Ad,Fiyat,Tur,Kategori,Servis from Menu where MekanAdi='" + req.params.MekanAdi + "' and Tur='Yiyecek'", function (
          ...
          res.render('mekanSahibiProfili', { veri: verisonucu.recordset, veri2: verisonucu2.recordset, veri3: verisonucu3.recordset });
          sql.close();
          sql.close();
        });
      });
    ...
    request1.query("select * from Mekan where MekanAdi='" + req.params.MekanAdi + "'", function (err, verisonucu2) {
      request2.query("select Ad,Fiyat,Tur,Kategori,Servis from Menu where MekanAdi='" + req.params.MekanAdi + "' and Tur='İcecek'", function (
        ...
        request3.query("select Ad,Fiyat,Tur,Kategori,Servis from Menu where MekanAdi='" + req.params.MekanAdi + "' and Tur='Yiyecek'", function (
          ...
          res.render('mekanBilgileri', { veri: verisonucu.recordset, veri2: verisonucu2.recordset, veri3: verisonucu3.recordset });
          sql.close();
          sql.close();
        });
      });
  ...
  sql.connect(webconfig, function (err) {
    ...
    request1.query("select * from Mekan where MekanAdi='" + req.params.MekanAdi + "'", function (err, verisonucu2) {
      request2.query("select Ad,Fiyat,Tur,Kategori,Servis from Menu where MekanAdi='" + req.params.MekanAdi + "'", function (err, verisonucu) {
        ...
        res.render('siparisver', { veri: verisonucu.recordset, veri2: verisonucu2.recordset });
        sql.close();
        sql.close();
      });
    });
...
module.exports.siparisverpost = function (req, res) {
  sql.connect(webconfig, function (err) {
    if (err) console.log(err);
    var request1 = new sql.Request();
    console.log('yeni', req.body.batux);
    request1.query("INSERT INTO Siparisler(Sipariş)  SELECT('" + req.body.batux + "')", function (err, verisonucu2) {
      if (err) {
        console.log(err);
      }
      res.send('basarili');
